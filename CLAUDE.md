...
- Import reusable environment loading, warning suppression, and logging configuration from `notebooks/common.py`.
...
- Print clearly labeled `INPUT`, `OUTPUT`, `STATE`, and `INTERMEDIATE RESULTS` values.
